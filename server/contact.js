import { isLikelyBot, parseContact } from "../src/lib/contactContract.js";
import { buildContactEmail } from "./contactEmail.js";

export const RESEND_ENDPOINT = "https://api.resend.com/emails";

export const readContactConfig = (env) => ({
...
export const handleContactRequest = async (
  rawBody,
  config,
  { allowUnsentWithoutKey = false, fetchImpl = fetch, logger = console } = {},
) => {
