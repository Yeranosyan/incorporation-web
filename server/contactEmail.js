import { COMPANY } from "../src/content/site.js";
...
const buildText = ({ name, email, company, message }) =>
  [
    "New website enquiry",
    "",
    `From:    ${name}`,
...
const buildHtml = ({ name, email, company, message }) => {
...
export const buildContactEmail = (contact) => ({
