...
import type { SyncScene as Scene } from "@/lib/syncScene";
import { SyncSolid } from "./SyncSolid";

export type SyncSceneProps = { scene: Scene; order: string; wide: boolean };

export function SyncScene({ scene, order, wide }: SyncSceneProps) {
