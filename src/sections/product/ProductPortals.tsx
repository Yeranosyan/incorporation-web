...
export type ProductPortalsProps = {
  intro: ProductContent["portalsIntro"];
  portals: ProductContent["portals"];
};

const ID_PREFIX = "portal";

export function ProductPortals({ intro, portals }: ProductPortalsProps) {
