...
import type { Integration } from "./SyncDiagram";
import { WriteBackCard } from "./WriteBackCard";

export type ProductIntegrationProps = { integration: Integration };

export function ProductIntegration({ integration }: ProductIntegrationProps) {
