...
export type PortalLink = ProductContent["portalsIntro"]["link"];
export type RoleHeaderProps = { roles: Role[]; active: number; link: PortalLink };

export function RoleHeader({ roles, active, link }: RoleHeaderProps) {
