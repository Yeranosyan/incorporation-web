...
export type ProductCycleProps = {
  cycle: ProductContent["cycle"];
  highlights: ProductContent["highlights"];
  comparison: ProductContent["comparison"];
};

export const WIDE_CYCLE_QUERY = "(min-width: 48rem)";

export function ProductCycle({ cycle, highlights, comparison }: ProductCycleProps) {
