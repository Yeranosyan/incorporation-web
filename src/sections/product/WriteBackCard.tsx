...
export type WriteBackCardProps = {
  label: string;
  outbound: ProductContent["integration"]["outbound"];
  from: string;
  to: string;
  className?: string;
};

export function WriteBackCard({ label, outbound, from, to, className }: WriteBackCardProps) {
  return (
