...
const renderComparison = (focus) => render(<ProductComparison comparison={comparison} focus={focus} />);

const placesOf = (container) =>
  [...container.querySelectorAll("[data-row]")].map((row) => row.querySelector(".comparison-line").dataset.place);
...
describe("ProductComparison", () => {
  ...
  it("counts the focused statement out of all four", () => {
    ...
    const reel = container.querySelector(".comparison-count .digit-reel");
