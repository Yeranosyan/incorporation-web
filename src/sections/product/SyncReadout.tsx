...
export type SyncTone = keyof typeof TONES;
export type SyncItem = { label: string; detail: string };
export type SyncReadoutProps = {
  label: string;
...
const labelKey = ({ label }: SyncItem) => label;

export function SyncReadout({ label, items, value, active, tone = "read" }: SyncReadoutProps) {
  return (
