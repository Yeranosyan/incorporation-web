...
export type Credential = MembershipContent["credential"];
export type MembershipStepsProps = {
...
const layerKey = ({ label }: Credential["layers"][number]) => label;

export function MembershipSteps({ credential, step, onSelect }: MembershipStepsProps) {
